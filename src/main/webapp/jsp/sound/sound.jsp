...
<security:csrfMetaTags/>
	...
	<script type="text/javascript" src="${basepath}skin/js/recordmp3.js"></script>
    ...
    <script>  
        ...
        function funUpload1() {  
            ...
            **/
            ...
            var mp3Name = encodeURIComponent('audio_recording_' + new Date().getTime() + '.mp3');  
            params.mp3Name=mp3Name;
            params.file=mp3Blob;
            var url=basepath+'sound/SoundController/upload';
            $.ajax({
	    		url:SKY.urlCSRF(url),
	    		type: "POST",
	    		data:params,
