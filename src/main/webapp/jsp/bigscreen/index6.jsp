...
<script src="${basepath}skin/echarts/taian.js"></script>
<script type="text/javascript" src="${basepath}jsp/dap/larscreen/index6.js"></script>
<script type="text/javascript">
$(function() {
	   $("#prev_btn").click(function () { window.location.href = 'index5' });
       $("#next_btn").click(function () { window.location.href = 'index' });
       $("#dian img").attr("src", "../../skin/images/larscreen/dian01.png");
       $("#dian img:eq(6)").attr("src", "../../skin/images/larscreen/dian01_d.png");  
       Chart2();
       Chart3();
       Chart4();
       Chart10();
...
<body>
 ...
 <div class="row" style="width:100%;height:98%; padding:10px 0px 10px 20px; margin-right:-20px">
    <div class="row" style="height: 80px;margin-left:10px; margin-right:10px;  background: url('../../skin/images/larscreen/title_bg02.png') no-repeat center top; text-align:center;color:#fff;font-size:22px;font-weight:600;line-height:60px">泰安市服务发展数据分析</div>
    <div class="row" style="margin-left:10px;margin-right:-15px;width:100%">
        <div class="col-md-5 box" style="height:90%;width:41%; margin-right:9px;"  id="chart1">
        </div>
        <div class="col-md-7">
            <div class="row">
