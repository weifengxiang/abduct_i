...
<script type="text/javascript" src='${basepath}jsp/ywbl/ajsh/listtbstajshxx.js'></script>
...
<table class='noborder'>
	<tr style="height: 34px">
		...
		<td><input  class="easyui-textbox" data-options="prompt:'输入审核人'" name="q_shenhr"  id="q_shenhr" ></input></td>				
...
<div data-options=" region:'center',iconCls: 'icon-table'" title="案件审核管理">
<table  id="listtbstajshxxdg" class="easyui-datagrid" style="width: 100%; height: 100%"
	data-options="
			region:'center',
			fit:true,
			border:false,
			...
			onDblClickRow:function(rowIndex, rowData){
								//SKY_EASYUI.beginEdit('listtbstajshxxdg',rowIndex);
						  },
	...
	<thead>
		<tr>
			<th data-options="field: 'checked', checkbox:true"></th>
				...
				<th data-options="field:'shenhr',width:180,
				editor:{
						type:'textbox',
						options:{
							required:true
...
<div id="tb" style="height: auto">
	<a href="javascript:void(0)" class="easyui-linkbutton"
		data-options="iconCls:'icon-add',plain:true" onclick="addTbStAjshxx()">增加</a>
	<a href="javascript:void(0)" class="easyui-linkbutton"
		data-options="iconCls:'icon-edit',plain:true" onclick="editTbStAjshxx()">修改</a>
	<a href="javascript:void(0)" class="easyui-linkbutton"
		data-options="iconCls:'icon-20130408025545236_easyicon_net_30',plain:true" onclick="delTbStAjshxx()">删除</a>
	<a href="javascript:void(0)" class="easyui-linkbutton"
		data-options="iconCls:'icon-06',plain:true" onclick="detailTbStAjshxx()">查看明细</a>
</div>
</body>
</html>