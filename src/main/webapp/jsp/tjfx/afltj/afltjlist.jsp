...
<script type="text/javascript" src='${basepath}jsp/tjfx/afltj/afltjlist.js'></script>
...
<table  id="listafl" class="easyui-datagrid" style="width: 100%; height: 100%"
	...
	<thead>
		<tr>
			...
			<th data-options="field:'NAME',width:180">案发地</th>
			<th data-options="field:'NUM',width:180">案发数量</th>
		</tr>
	</thead>
</table>
</div>
