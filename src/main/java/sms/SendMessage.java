...
public class SendMessage {
	public void doIt() throws Exception {
		 ...
		 * 最后一个参数表示设备的型号，可选
		 */
		SerialModemGateway gateway = new SerialModemGateway("modem.com1", "COM3", 9600, "Siemens", "TC35");
		...
		OutboundMessage msg = new OutboundMessage("18553106550", "你好a"); // 参数1：手机号码 参数2：短信内容
